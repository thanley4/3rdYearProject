...
from ObjectTrackingV3 import assign_objects
...
#
#
# def calculate_velocity(j, objects_in_frame, objects_in_last_frame):
#     for i in range(0, j):
#         print(objects_in_last_frame['position'][i, 0])
#         print(objects_in_frame['position'][i, 0])
#         objects_in_frame['velocity'][i, 0] = (objects_in_last_frame['position'][i, 0] - objects_in_frame['position'][
#             i, 0]) / (1 / 30) / 20
#         objects_in_frame['velocity'][i, 1] = (objects_in_last_frame['position'][i, 1] - objects_in_frame['position'][
#             i, 1]) / (1 / 30) / 20
#         print("X Velocity: ", objects_in_frame['velocity'][i, 0], "m/s, Y Velocity: ",
#               objects_in_frame['velocity'][i, 1], "m/s")
#     return
...
def update(frame_number):
    ...
    ax.scatter(objects_in_frame['position (t-1)'][:, 0], objects_in_frame['position (t-1)'][:, 1],
               s=objects_in_frame['size'], edgecolors=[0,1,1],
               facecolors="None")
