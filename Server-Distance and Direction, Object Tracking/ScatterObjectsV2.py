...
plotting_data_x = [0]
plotting_data_y = [0]
plotting_data_size = [0]
plotting_data_colour = ['red']

scatter_plot = ax.scatter(plotting_data_x, plotting_data_y, plotting_data_size, plotting_data_colour)
...
def update(me):
    ...
    for i in create_objects():
        ...
        plotting_data_colour.append(object_colours[i.object_id])
